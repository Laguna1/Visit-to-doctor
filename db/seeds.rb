...
# u4 = User.create({ fullname: 'Kurt Backham', mobile_no: '380681111111', email: 'kurt@example.com', password: 'aaaaaaaa', password_confirmation: 'aaaaaaaa', role_id: 2, category_id: 1 })
# u5 = User.create({ fullname: 'Jack Nortingen', mobile_no: '380691111111', email: 'jack@example.com', password: 'aaaaaaaa', password_confirmation: 'aaaaaaaa', role_id: 2, category_id: 1 })
# u6 = User.create({ fullname: 'Eddy Murphy', mobile_no: '380700000000', email: 'eddy@example.com', password: 'aaaaaaaa', password_confirmation: 'aaaaaaaa', role_id: 2, category_id: 1 })
# u7 = User.create({ fullname: 'Jackob Wolfskin', mobile_no: '380710101010', email: 'jackob@example.com', password: 'aaaaaaaa', password_confirmation: 'aaaaaaaa', role_id: 2, category_id: 2 })
# u8 = User.create({ fullname: 'Mila Pristley', mobile_no: '380721212121', email: 'mila@example.com', password: 'aaaaaaaa', password_confirmation: 'aaaaaaaa', role_id: 2, category_id: 2 })
